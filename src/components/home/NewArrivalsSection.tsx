    ...
    <div className="bg-muted/30 py-10">
      <div className="container mx-auto px-4">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-foreground">
              {language === 'fa' ? 'تازه‌ها' : language === 'ar' ? 'الوافدون الجدد' : 'New Arrivals'}
            </h2>
          </div>
          <Button
            variant="ghost"
        ...
        <p className="text-sm text-muted-foreground mb-6">
          {language === 'fa' 
            ? 'محصولات جدید با آخرین پیشنهادات' 
            : language === 'ar' 
            ? 'منتجات جديدة مع أحدث العروض'
            : 'The shops with the latest offerings'}
        </p>
            ...
            {products.map((product) => (
              ...
              >
                ...
                <div className="relative aspect-square overflow-hidden bg-muted">
                  ...
                  />
                  {/* New Badge */}
                  <div className="absolute top-2 left-2 bg-gradient-to-r from-green-500 to-emerald-500 text-white text-xs font-bold px-2 py-1 rounded shadow-lg">
                    NEW
                  </div>
                </div>
