...
const Contact: React.FC = () => {
  ...
  const contactInfo = [
    ...
    {
      icon: Phone,
      title: language === 'fa' ? 'تلفن ثابت' : language === 'ar' ? 'الهاتف' : 'Phone',
      content: '۰۲۱-۸۸۹۲۲۹۳۶-۹',
      link: 'tel:+982188922936',
    ...
    },
    {
      ...
      content: language === 'fa' ? 'تهران، چهارراه ولیعصر' : language === 'ar' ? 'طهران، تقاطع وليعصر' : 'Tehran, Valiasr Square',
      link: 'https://maps.google.com/?q=Valiasr+Square+Tehran',
      color: 'from-purple-500 to-pink-500',
    },
    {
      icon: Clock,
      title: language === 'fa' ? 'ساعات کاری' : language === 'ar' ? 'ساعات العمل' : 'Business Hours',
      content: language === 'fa' ? 'شنبه - پنج‌شنبه: ۹ صبح - ۶ عصر' : language === 'ar' ? 'السبت - الخميس: 9 ص - 6 م' : 'Saturday - Thursday: 9 AM - 6 PM',
      link: '#',
